...
export default function Participant() {
    ...
    const canEdit = hasPermission(user, "participants", "edit");
        ...
        },
        {
            ...
            renderCell: (params) => (
                <Box direction="row" spacing={1}>
                    <IconButton onClick={() => navigate(`/admin/participant/edit-participant/${params.row._id}`)} disabled={!canEdit}>
        ...
        <Box style={{ padding: "1.25rem", height: "100%" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
                    ...
                    />
                    {canEdit && (
                        <Button sx={{ bgcolor: "black", color: "white", fontWeight: '500' }} variant="outlined" startIcon={<AddOutlinedIcon />} onClick={() => navigate("/admin/participant/add-participant")}>
                            Add Participants
                        </Button>
                    )}
                </div>
